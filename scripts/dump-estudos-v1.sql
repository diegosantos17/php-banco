...
CREATE TABLE `motorista_situacao` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='Tabela que contém as situações dos motoristas';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `motorista_situacao` VALUES (1,'Regular','Motorista em situação regular'),(2,'Atestado Médico','Motorista afastado com atestado médico'),(3,'Black List','Motorista entrou na blacklist por algum motivo'),(4,'Férias','Motorista de férias'),(5,'Óbtio','Motorista faleceu');
...
INSERT INTO `usuario` VALUES (1,'Administrador','admin@admin.com','683e60cff9f09684602dddc7e296722f',_binary '',NULL,'2020-12-10 15:57:34',NULL,'2020-12-10 15:57:34'),(2,'Robô','robo@gmail.com','683e60cff9f09684602dddc7e296722f',_binary '',NULL,'2020-12-10 15:57:34',NULL,'2020-12-10 15:57:34');
...
INSERT INTO `veiculo` VALUES (1,'Volvo FH 540','DMK3097','36851539310',1,2020,2019,4,1,1,'2020-12-09 17:00:00','2020-12-09 17:00:00',1),(2,'Scania R 450','CJC1752','41524540559',2,2018,2018,5,1,1,'2020-12-09 17:00:00','2020-12-09 17:00:00',1),(3,'Volvo FH 460','BZW0943','13913313230',1,2015,2014,4,1,1,'2020-12-09 17:00:00','2020-12-09 17:00:00',1),(4,'Mercedes-Benz Actros 2651','BUS2333','22164348086',3,2020,2020,4,2,1,'2020-12-09 17:00:00','2020-12-09 17:00:00',1),(5,'DAF XF 105 510','CTA1790','02515849657',4,2017,2017,5,2,1,'2020-12-09 17:00:00','2020-12-09 17:00:00',1),(6,'Scania R 500','CBB2058','61785905776',2,2020,2019,5,3,1,'2020-12-09 17:00:00','2020-12-09 17:00:00',1),(7,'Mercedes-Benz Actros 2546','BOA8560','32504215696',3,2015,2015,4,3,1,'2020-12-09 17:00:00','2020-12-09 17:00:00',1),(8,'Mercedes-Benz Axor 2544','ERH5951','23616424727',3,2018,2018,5,3,1,'2020-12-09 17:00:00','2020-12-09 17:00:00',1),(9,'Mercedes-Benz Axor 3344','CGB7741','27165756405',3,2019,2018,5,3,1,'2020-12-09 17:00:00','2020-12-09 17:00:00',1),(10,'Volvo FH 500','GEP5749','16364137858',1,2019,2018,5,3,1,'2020-12-09 17:00:00','2020-12-09 17:00:00',1);
...
CREATE TABLE `veiculo_multa` (
  ...
  `multa_situacao_id` int(11) NOT NULL COMMENT 'Situação da multa',
  `criado_por` int(11) DEFAULT NULL COMMENT 'Usuário que criou o registro',
  `criado_em` datetime DEFAULT current_timestamp() COMMENT 'Data da criação do registro',
  `alterado_por` int(11) DEFAULT NULL COMMENT 'Usuário responsável pela última alteração no registro.',
  `alterado_em` datetime DEFAULT current_timestamp() COMMENT 'Data da última alteração no registro',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Registros de multa dos veículos no sistema.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-12-11 12:23:42
