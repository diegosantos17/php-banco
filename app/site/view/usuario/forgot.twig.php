...
<head>
    ...
    <title>Trainning POO MVC - Esqueci a senha</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">Sem problemas, vamos ajudar a recuperá-la!</p>
                                    </div>
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="{{BASE}}auth">Já possuí conta? Acesse!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
