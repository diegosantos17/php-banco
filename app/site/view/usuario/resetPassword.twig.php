                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="{{BASE}}/usuario/resetPassword/{{ response.data.usuario.token }}">
                                <input type="hidden" id="id" name="id" value="{{ response.data.usuario.id }}" />
                                ...
                                <input type="submit" class="btn btn-primary btn-user btn-block" value="Redefinir Senha" />
                            </form>                    
                        </div>
                    </div>
                </div>
